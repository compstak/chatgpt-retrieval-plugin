...
from chatgpt_retrieval_plugin.api.schemas.models import Document, DocumentChunk, DocumentChunkMetadata
...
def create_document_chunks(
    ...
    metadata = DocumentChunkMetadata(**doc.metadata.__dict__) if doc.metadata is not None else DocumentChunkMetadata()
